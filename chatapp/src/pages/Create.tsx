          ...
          <View style={style.leftContent}>
            ...
            <View style={style.inputs}>
              <TextInput
                ...
                placeholder="Название вашей встречи"
              />
              <View style={{paddingVertical: 10}}>
                ...
                {$config.PSTN ? (
                  <View style={style.checkboxHolder}>
                    ...
                    />
                    <Text style={style.checkboxTitle}>
                      Используйте PSTN (присоединяйтесь по номеру номера)
                    </Text>
                  </View>
                ) : (
                  <></>
              ...
              <PrimaryButton
                ...
                onPress={() => createRoom()}
                text={loading ? 'Загрузка...' : 'Создать встречу'}
              />
              <HorizontalRule />
              <SecondaryButton
                onPress={() => history.push('/join')}
                text={'Есть идентификатор встречи?'}
              />
            </View>
          </View>
        </View>
